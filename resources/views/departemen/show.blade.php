<x-layouts.main>
    <div class="min-h-screen bg-zinc-50 dark:bg-zinc-900">
        ...
        <div class="container mx-auto px-4 py-12">
            <div class="space-y-8">
                <!-- Anggota Departemen -->
                @if($department->hasHeadMembers() || $department->hasActiveMembers())
                    <div class="bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg p-6">
                        ...
                        @if($department->hasHeadMembers())
                            <div class="mb-8">
                                <h3 class="text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-4">Kepala Staff</h3>
                        ...
                        @if($department->hasActiveMembers())
                            <div>
                                <div class="flex items-center justify-between mb-4">
                                    <h3 class="text-lg font-semibold text-zinc-900 dark:text-zinc-100">Staff</h3>
                                    <p class="text-sm text-zinc-500 dark:text-zinc-400">{{ $department->activeMembers->count() }} anggota aktif</p>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
